    ...
    public class TVEElement : StyledMonoBehaviour
    {
        ...
        void AddElementByType(Material material)
        {
            ...
            if (validType)
            {
                ...
                for (int i = 0; i < volumeDataSet.Count; i++)
                {
                    ...
                    if (elementData.buffer == volumeData.bufferType)
                    {
        ...
        void DrawGizmos(bool selected)
        {
            ...
            if (elementData != null)
            {
                ...
                {
                    if (IsElementInVolume("TVE_ColorsCoord"))
                    {
                ...
                {
                    if (IsElementInVolume("TVE_ExtrasCoord"))
                    {
                        Gizmos.color = genericColor;
                    }
                    else
                ...
                {
                    if (IsElementInVolume("TVE_MotionCoord"))
                    {
                        Gizmos.color = genericColor;
                    }
                    else
                ...
                {
                    if (IsElementInVolume("TVE_ReactCoord"))
                    {
                        Gizmos.color = genericColor;
                    }
                    else
        ...
        bool IsElementInVolume(string globalCoord)
        {
            var inVolume = false;
            ...
            var bounds = new Bounds(new Vector3(posX, coordUp.x, posZ), new Vector3(sizeX, coordUp.y, sizeZ));
